...
$component_file   ||=  "$Bin/GO_Classify/cellular_component.txt"; # 2014-12-12 ~ 
$function_file    ||=  "$Bin/GO_Classify/molecular_function.txt"; # 2014-12-12 ~ 
$process_file     ||=  "$Bin/GO_Classify/biological_process.txt"; # 2014-12-12 ~ 
$foutdir          ||=  './';
$help             ||=  "";
#-------------------------------------------------------------------------------------
&help () if($help);
...
#print Dumper(\@three_go_tree_file);
#print Dumper(\%three_go_tree_hash);
#print Dumper(\%three_go_tree_key);
...
system("Rscript $Bin/GOClassificationMap2.r --infile $foutdir/$fkey.GO.list --outpath $foutdir --key $fkey --rotation 80");
