...
my $Rscript = "/share/nas2/genome/biosoft/R/2.15.3/bin/Rscript"; #2014-12-09 ~ 
...
#`ssh compute-0-14 /share/nas2/genome/biosoft/R/3.0.1/bin/Rscript $od/topGO.R`;
`$Rscript $od/topGO.R`;

chdir $od;
`/share/nas2/genome/bmksoft/tool/svg2xxx/v1.0/svg2xxx $key.topGO_BP.svg`;
`/share/nas2/genome/bmksoft/tool/svg2xxx/v1.0/svg2xxx $key.topGO_MF.svg`;
`/share/nas2/genome/bmksoft/tool/svg2xxx/v1.0/svg2xxx $key.topGO_CC.svg`;
#`rm $od/topGO.R`;
