...
p1 <- p1 +theme_bw()+ theme(  
		...
		theme(legend.key = element_blank(),legend.title = element_blank())+guides(col = guide_legend(ncol = 4))
...
p <- p +theme_bw()+ theme(  
				panel.grid=element_blank(), 
				axis.text.x=element_text(colour="black"),axis.text.y=element_text(colour="black"),panel.border=element_rect(colour = "black"))+
		theme(legend.key = element_blank(),legend.title = element_blank(),axis.text.x=element_text(angle=45,hjust=1))+guides(fill = guide_legend(ncol = 4))
